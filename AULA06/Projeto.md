Entendi o problema, Ana! O erro estava em mim mesma — eu estava colocando **todo o documento dentro de um bloco de código gigante**, e por isso os blocos internos (JSON, diagramas) quebravam a formatação ao copiar. Vou te entregar agora **sem o bloco externo**, só com os blocos internos de código nos lugares certos, pra manter a formatação de linha por linha.

Também adicionei as referências que você trouxe, encaixadas nos pontos certos do documento (pré-processamento/limpeza, chunking, pipeline de ingestão).
...
*(Fonte: "Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks", Lewis et al., 2020, Meta AI — paper base do conceito de RAG, https://arxiv.org/abs/2005.11401)*
...
*(Fonte: conceito de desnormalização em bancos de dados — "Designing Data-Intensive Applications", Martin Kleppmann, cap. 2)*
...
*(Fonte: "Speech and Language Processing", Jurafsky & Martin, capítulo sobre pré-processamento de texto — versão gratuita disponível em https://web.stanford.edu/~jurafsky/slp3/)*
...
*(Fonte: Documentação da Unicode/UTF-8 para tratamento de codificação, https://docs.python.org/3/howto/unicode.html)*
...
*(Fonte: Documentação oficial do LangChain sobre Document Loaders e estratégias de ingestão, https://python.langchain.com/docs/)*
...
*(Fontes: LangChain Documentation — "Text Splitters", https://python.langchain.com/docs/how_to/#text-splitters; LangChain Overview, https://docs.langchain.com/oss/python/langchain/overview#text-splitters; Pinecone Learning Center — "Chunking Strategies for LLM Applications", https://www.pinecone.io/learn/chunking-strategies/)*
...
| Fonte | OpenAI API Docs (developers.openai.com/api/docs/models/text-embedding-3-large); CodeLint.Dev, "Embedding Models 2025" |
...
[Documentos fonte: HTML / PDF / Prints]
        |
        v
[Extração: BeautifulSoup4 | pdfplumber-PyPDF2 | Tesseract OCR]
        |
        v
[Limpeza e normalização: remove ruido, corrige codificacao]
        |
        v
...
| Fonte | Ergini, "BGE-M3 vs OpenAI Embeddings" (ago/2026); CodeLint.Dev, "Embedding Models 2025" |
...
| Chunking | Por parágrafo, sem overlap | Cada parágrafo já é uma regra 
